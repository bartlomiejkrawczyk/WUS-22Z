...
sudo mysql -e "CHANGE MASTER TO MASTER_HOST='$MASTER_DATABASE_ADDRESS', MASTER_PORT=$MASTER_DATABASE_PORT, MASTER_USER='$DATABASE_USER', MASTER_PASSWORD='$DATABASE_PASSWORD';"
